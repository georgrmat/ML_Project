...
st.markdown("age : *age in years*   sex : *(1 = male; 0 = female)*-  \nline cp : *chest pain type*-  \nline trestbps : *resting blood pressure (in mm Hg on admission to the hospital)*-  \nline chol : *serum cholestoral in mg/dl)*-  \nline fbs : *(fasting blood sugar > 120 mg/dl) (1 = true; 0 = false)*-  \nline restecg : *resting electrocardiographic results*-  \nline thalach : *maximum heart rate achieved*-  \nline exang : *exercise induced angina (1 = yes; 0 = no)*-  \nline oldpeak : *ST depression induced by exercise relative to rest*-  \nline slope : *the slope of the peak exercise ST segment*-  \nline ca : *number of major vessels (0-3) colored by flourosopy*-  \nline thal : *3 = normal; 6 = fixed defect; 7 = reversable defect*")
