...
#              "leaf_size": 2}
      ...
      self.grid_param= {"n_neighbors": [k for k in range(2,7)],
...
if Model in ['KNeighbors','Logistic Regression','Support Vector Machine Algorithm','Naive Bayes Algorithm']:
  ...
  search =RandomizedSearchCV(choix_classifieur.algo,choix_classifieur.grid_param,cv=5)#, n_iter = 100, cv = 20, verbose=2, random_state=1, n_jobs = -1)
  result = search.fit(x_train, y_train)
